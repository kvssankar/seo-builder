      ...
      <div className="row">
        ...
        <div className="col-8 hero-text"> 
          <div className="firebase">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed cumque, iusto ut, incidunt mollitia eius nisi repudiandae enim, rerum assumenda voluptatibus blanditiis omnis aut magnam voluptatem cum praesentium. Nisi, voluptate? <a href="/">Learn more</a></p>
            ...
            <div class="form-check form-check-inline">
              ...
              <label class="form-check-label" for="inlineRadio1">Node.js</label>
            </div>
            <div class="form-check form-check-inline">
